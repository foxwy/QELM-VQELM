...
if __name__ == '__main__':
    ...
    if save_excel_flag:
        wb = Workbook()
        ws = wb.active
        ws.append(['N_train', 'N_test', 'm_init', 'RMSE_1', 'RMSE_2', 'RMSE_5', 'RMSE_6',\
    ...
    for N_list in N_list_C:
        ...
        for m_init in m_init_list:
            ...
            if N_train >= m:
                ...
                best_RMSE_5 = np.inf
                best_RMSE_6 = np.inf
                for row in range(10 * rows + 1, 10 * (rows + 1) + 1):
                    ...
                    # -----excel-----
                    if save_excel_flag:
                        ws.append([N_train, N_test, m_init, RMSE_1, RMSE_2, RMSE_5, RMSE_6, time_exp1_train, time_exp1_test, \
