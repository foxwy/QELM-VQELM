...
def Plot_data(flag=1):
    ...
    Tr4 = []
    j = 1
    for r1, r2, r3, r4, tr1, tr2, tr3, tr4 in zip(ws['A'][j:j + 20], ws['B'][j:j + 20], ws['C'][j:j + 20], ws['D'][j:j + 20], 
                              ws['E'][j:j + 20], ws['G'][j:j + 20], 
                              ws['I'][j:j + 20], ws['K'][j:j + 20]):
        R1.append(r1.value)
        R2.append(r2.value)
        R3.append(r3.value)
        R4.append(r4.value)
    ...
    print('\n%.3f & %.3f & %.3f & %.3f & %.3f & %.3f & %.3f & %.3f & %.2e & %.2e & %.3f & %.3f \\\\' % (R1_mean, R2_mean, R3_mean, R4_mean,
